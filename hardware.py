                    ...
                    while True:
                        while True:
                            ...
                            for coord in thr_coord:
                                logging.debug("Go to " + str(round(float(coord[0]), 5)) + " " + str(
                                    round(float(coord[1]) * axes.RH_MAX, 5)) + " (" + str(index) + "/" + str(
                                    len(thr_coord)) + ")")
                                logging.info("Step " + str(index) + "/" + str(len(thr_coord)) + " (" + str(
                                    round(float(coord[0]), 5)) + " " + str(
                                    round(float(coord[1]) * axes.RH_MAX, 5)) + ")")
